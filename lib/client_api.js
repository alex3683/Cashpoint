...
exports.initialize = function( httpServer, storage, debtCalculator ) {
   ...
   everyone.now.setVoucherToRepaid = function( voucher, callback ) {
      voucher.repaid = true;
      voucher.repaid_date = new Date();
      voucher = dataMapper.voucherForDataBase( voucher );
      storage.updateVoucher( voucher, flattenVoucherCallback( eventEmittingCallback( callback, 'voucherRepaid' ) ) )
   };
